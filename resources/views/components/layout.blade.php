        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Programs</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Membership Offers</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Suppliment Store</a>
                    ...
                    <div class="">
                        @if (Route::has('login'))
                            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="text-sm font-semibold leading-6 text-gray-900">Log
                                        in</a>
                ...
                <div class="lg:flex lg:items-start lg:gap-8">
                    ...
                    <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <ul class="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" class="text-gray-700 transition hover:opacity-75"> Marketing
                                        Calendar </a>
                                </li>
